        ...
        <div class="row _ma_ol_lk">
          <div class="col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="_ne_ol_vd_pl">
              <div style="background-image:url(assets/img/Family.jpg);" class="_ne_ol_vd_pr"></div>
              <h2>Family law</h2>       
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="_ne_ol_vd_pl">
              <div style="background-image:url(assets/img/Accident.jpg);" class="_ne_ol_vd_pr"></div>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="_ne_ol_vd_pl">
              <div style="background-image:url(assets/img/BusinessTaxation.jpg);" class="_ne_ol_vd_pr"></div>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="_ne_ol_vd_pl">
              <div style="background-image:url(assets/img/CivilLitigation.jpg);" class="_ne_ol_vd_pr"></div>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="_ne_ol_vd_pl">
              <div style="background-image:url(assets/img/Transporation.jpg);" class="_ne_ol_vd_pr"></div>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="_ne_ol_vd_pl">
              <div style="background-image:url(assets/img/img-01.jpg);" class="_ne_ol_vd_pr"></div>
              <h2>Education Law</h2>       
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="_ne_ol_vd_pl">
              <div style="background-image:url(assets/img/ConstructionAccidents.jpg);" class="_ne_ol_vd_pr"></div>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="_ne_ol_vd_pl">
              <div style="background-image:url(assets/img/Financelaw.jpg);" class="_ne_ol_vd_pr"></div>
    ...
    <section class="_ng_cs_we_rw">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6">
            <div class="_lk_bg_cd">
              <img src="assets/img/designing.png">
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6">
            <div class="_lk_bg_cd">
              <img src="assets/img/ecomerce.png">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-12">
            <div class="_nb_cd_er">
              <h2>Address</h2>
              <ul>
                <li><p>1475 , Ist Floor, Najafagarh ,Near Najafagarh Metro Station, New Delhi 110043</p></li>

                <li><p>advnitin1324@gmail.com</p></li>
                <li><p>+91 9871923821</p></li>
                <li><p>+91 9599101613</p></li>
              </ul>
            </div>
          </div>
        </div>
